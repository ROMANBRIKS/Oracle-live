...
const TreasuryDashboard: React.FC = () => {
  ...
  const totalHotAssets = treasury.reduce((acc, curr) => acc + curr.hot_wallet_balance, 0);
  const totalColdAssets = treasury.reduce((acc, curr) => acc + curr.cold_wallet_balance, 0);
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 pb-24 font-sans">
      ...
      <div className="flex items-center justify-between mb-10 max-w-7xl mx-auto">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h1 className="text-4xl font-black italic tracking-tighter uppercase flex items-center gap-3">
              <ShieldCheck className="text-indigo-500" /> Treasury <span className="text-white/20">Control</span>
            </h1>
            <p className="text-[10px] font-bold text-white/30 uppercase tracking-[0.3em] mt-1 ml-1">Universal Asset Liquidity & Risk Management</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
           <div className="bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-2xl flex items-center gap-3">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-emerald-500">Vault Secure</span>
           </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            ...
            >
               ...
               <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/60 mb-2">Aggregate Hot Balance</p>
               <h3 className="text-4xl font-black italic tracking-tighter">${totalHotAssets.toLocaleString()}</h3>
            </motion.div>
            ...
            >
               <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 mb-2">Offline Cold Storage</p>
               <h3 className="text-4xl font-black italic tracking-tighter">${totalColdAssets.toLocaleString()}</h3>
            </motion.div>
            ...
            <motion.div 
               ...
               className="p-8 rounded-[2.5rem] bg-zinc-900 border border-white/5"
            >
               <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 mb-2">Pending Discharge</p>
               <h3 className="text-4xl font-black italic tracking-tighter text-amber-500">
                  ${treasury.reduce((acc, curr) => acc + curr.pending_withdrawals, 0).toLocaleString()}
               </h3>
            </motion.div>
            ...
            >
               <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/20 mb-2">System Health</p>
                  <h3 className="text-xl font-black italic tracking-tighter text-emerald-500 uppercase">Optimize</h3>
               </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             ...
             >
                <div className="flex items-center justify-between mb-8">
                   <div className="flex items-center gap-3">
                      ...
                      <div>
                         <h4 className="text-lg font-black italic tracking-tighter uppercase">{item.currency}</h4>
                         <span className="text-[9px] font-black uppercase tracking-widest text-white/20">Network Asset</span>
                      </div>
                   </div>
                   {item.low_liquidity ? (
                      <div className="px-3 py-1 bg-red-500/20 border border-red-500/30 rounded-full flex items-center gap-2">
                         <AlertTriangle size={12} className="text-red-500" />
                         <span className="text-[9px] font-black uppercase tracking-widest text-red-500">Low Liquidity</span>
                      </div>
                   ) : (
                ...
                <div className="space-y-6 mb-10">
                   <div className="flex items-center justify-between p-4 rounded-2xl bg-black/40 border border-white/5">
                      <div className="flex items-center gap-3">
                         ...
                         <span className="text-[10px] font-bold uppercase tracking-widest text-white/40">Hot Wallet</span>
                      </div>
                   ...
                   <div className="flex items-center justify-between p-4 rounded-2xl bg-black/40 border border-white/5 opacity-60">
                      <div className="flex items-center gap-3">
                         ...
                         <span className="text-[10px] font-bold uppercase tracking-widest text-white/40">Cold Wallet</span>
                      </div>
           ...
           >
              ...
              <p className="text-[10px] font-black uppercase tracking-widest text-white/20">Initialize New Currency</p>
        ...
        <div className="mt-16 bg-zinc-900/50 border border-white/5 rounded-[3rem] p-10 flex flex-col md:flex-row items-center justify-between border-b-4 border-b-indigo-500">
           <div className="flex items-center gap-6 mb-6 md:mb-0">
              ...
              <div>
                 <h3 className="text-xl font-black italic tracking-tighter uppercase">Audit Archive</h3>
                 <p className="text-[10px] font-bold text-white/20 uppercase tracking-widest mt-1">Reviewing 1,492 historical ledger entries</p>
              </div>
           </div>
      ...
      <div className="mt-20 flex flex-col items-center gap-4 opacity-10">
         <div className="text-[8px] font-black uppercase tracking-[1em]">Universal Oracle Treasury Layer</div>
         <div className="flex items-center gap-6">
            <Coins size={12} />
            <Wallet size={12} />
            <ShieldCheck size={12} />
