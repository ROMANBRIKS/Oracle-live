...
import { Loader2, ArrowLeft, Camera, Mic, MicOff, CameraOff, Power, ShieldAlert } from "lucide-react";
...
const HostLiveRoom: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
       ...
       {/* Main Stage */}
       <main className="flex-1 relative bg-zinc-950 flex items-center justify-center p-6">
          <div 
             ref={localVideoRef}
             className="w-full h-full max-h-[80vh] aspect-video bg-black rounded-[4rem] border border-white/10 shadow-[0_0_100px_rgba(0,0,0,1)] relative overflow-hidden"
          >
             {(!streaming || loading) && (
       ...
       {/* Interaction Sidebar Placeholder */}
       <div className="fixed right-10 top-1/2 -translate-y-1/2 space-y-4">
          <div className="w-14 h-14 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl flex flex-col items-center justify-center">
